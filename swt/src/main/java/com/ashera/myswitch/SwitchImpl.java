...
public class SwitchImpl extends BaseWidget implements IDrawable, IHasMultiNativeWidgets, ICustomMeasureHeight, ICustomMeasureWidth{
	...
	public void loadAttributes(String attributeName) {
		...
		ConverterFactory.register("Switch.tintMode", new TintMode());
		WidgetFactory.registerAttribute(localName, new WidgetAttribute.Builder().withName("drawableTintMode").withType("Switch.tintMode").withOrder(-10));
...
return getLastBaselineToBottomHeight();				}
    ...
    private FontData[] getFontData() {
    	FontData[] fontData = this.newFont == null ? label.getFont().getFontData() : this.newFont.getFontData();
    	return fontData;
    }
